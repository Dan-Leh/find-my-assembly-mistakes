...
MODEL_NAMES = ["gca_from_VISION", "gca_fda75%_moreaug", "gca_fda50%_moreaug"]
...
for model_idx, model_name in enumerate(MODEL_NAMES):
    ...
    save_root = "" # os.path.join("/shared/nl011006/res_ds_ml_restricted/dlehman/Files_for_Tim_VISION/Trained_models", 
